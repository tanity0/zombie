...
export class PixiScene {
  ...
  constructor(layers: SceneLayers) {
    ...
    mkFog(this.bgCloudLayer, getFogTexture(), FOG_BACK_ALPHA,
      { yFrac: 0.16, widthFrac: 1.6, heightFrac: 0.85, ampX: 18, ampY: 8, spdX: 0.00034, spdY: 0.00048, flow: 0.012, ph: 1.9 });
    // 森下霧(やまぎり): front forest の後ろ(森が手前で隠す)。少し上へ(下端は画面外まで伸ばし隙間なし)。
    mkFog(this.forestUnderLayer, getFogBankTexture(), FOG_FRONT_ALPHA,
      { yFrac: 0.80, widthFrac: 1.6, heightFrac: 0.95, ampX: 26, ampY: 9, spdX: 0.0008, spdY: 0.0008, flow: 0.030, ph: 3.1 });
    // 森上霧: 最前面・最下部。手前の森に被る低い霧。
    mkFog(this.frontBankLayer, getFogTexture(), FOG_TOP_ALPHA,
      { yFrac: 1.06, widthFrac: 1.6, heightFrac: 0.46, ampX: 18, ampY: 8, spdX: 0.00036, spdY: 0.0004, flow: 0.020, ph: 0.7 });
  }
