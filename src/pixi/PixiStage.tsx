...
const STAGE_TEXTURE_GROUPS: Record<string, readonly SortieTexturePath[]> = {
  ...
  lab: ['sprites/lab-floor/lab-floor-stage2.png', 'backgrounds/stage2-lab-far.jpg', 'backgrounds/stage2-near-horizon2.png', 'backgrounds/stage2-front.png', 'backgrounds/stage2-front2.png'],
...
const PixiStage: React.FC<PixiStageProps> = ({ width, height, onContextLost }) => {
  ...
  // 変な切り抜きになる)。preserveDrawingBuffer無しでもrender直後の同期toDataURLは有効。
      ...
      void (async () => {
        ...
        const [labGround, s3Far, s3Ground, s3Horizon, s3Near, s1Near, s2Far, s2Near, s2Front, s2Front2, s4Far, s4Front, s4Ground, s4Horizon, s3Front, s5Far, s5Horizon, s5Near, s5Front, s5Ground, tutFar, tutGround, tutFlow1, tutFlow2, tutRocks, tutNearRocks, tutFrontRocks, s7Far, s7Clouds, s1Sky, s1Castle, s1Moon] =
