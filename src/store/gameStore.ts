...
export const GLEN_REACH_WINDUP_MS = 504;            // 実効420ms・静止
...
// 1周期を**きっちり実効1.0秒**に割る: 溜め420ms(予告) + 実行220ms + 間360ms = 1000ms。
// (v3126時点は 300/220/480。v3138で社長指示により予告を+120msし、その分を間から引いた。)
...
export const GLEN_REACH_GAP_MS = 432;               // 実効360ms(= 1000 − 溜め420 − 実行220)
