...
describe('magnet: ammo pickup range mult (+10/20/30%) (§6.8 M31)', () => {
  it('scales by level and is ×1.0 without the skill', () => {
    ...
    expect(skillMagnetPullRadius(withSkill('magnet', 1))).toBe(100);
    expect(skillMagnetPullRadius(withSkill('magnet', 2))).toBe(150);
    expect(skillMagnetPullRadius(withSkill('magnet', 3))).toBe(250);
  });
