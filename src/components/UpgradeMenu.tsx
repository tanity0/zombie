...
const UpgradeMenu: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="glass-panel rounded-3xl w-full max-w-md overflow-hidden flex flex-col max-h-[88dvh] upgrade-menu-panel">
        <div className="px-5 pt-5 pb-3 text-center flex-none">
        ...
        <div className="px-3 pb-4 flex flex-col gap-2 overflow-y-auto min-h-0 overscroll-contain">
          {upgradeOptions.map(upgrade => (
            <button
              ...
              className="text-left p-3 rounded-2xl bg-white/5 active:bg-white/10 border border-white/10 transition-colors flex items-start gap-3 upgrade-menu-option"
            >
