...
const SHOTS: Shot[] = [
  // 正面(引き): アリーナ全体。3人は中央ステージ上=遠く小さい。焦点=ステージ。
  { bg: A('arena.jpg'), ox: 50, oy: 46, zf: 1.0, zt: 1.9, chars: [
    { src: TWIN, x: 47, y: 53, h: 13 }, { src: HERO, x: 50, y: 53.5, h: 14 }, { src: BOB, x: 53, y: 53, h: 13 },
  ] },
