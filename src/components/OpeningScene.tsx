...
// 撃つ側(社長指定v0.25.2010): 立ち1秒→構え1秒→撃つ→(静止)→次0.1→次0.2→最後(硝煙)は保持。
// 撃たれ側(社長指定v0.25.2011→2012→2014→2016): 被弾=撃つと同期→(静止)→次0.4→次0.4→最後(倒れ伏す)は保持。
// 【静止】撃たれた瞬間=赤くなった瞬間(2.0s)で両者とも2秒静止(社長指示v0.25.2017)。静止後に各自のテンポで再開。
const SHOOTER_TRACK = [{ t: 0, f: 1 }, { t: 1000, f: 3 }, { t: 2000, f: 4 }, { t: 4000, f: 5 }, { t: 4100, f: 2 }, { t: 4300, f: 6 }];
