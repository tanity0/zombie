...
// 間隔は社長指定(v0.25.2010): 立ち1秒→構え1秒→撃つ0.1→次0.1→次0.2→最後は保持。
const SHOOT_STEPS = [
  { t: 0, s: 1, v: 1 },     // 対峙(立ち)1.0s
  { t: 1000, s: 3, v: 1 },  // 銃を構える 1.0s
  { t: 2000, s: 4, v: 2 },  // 発砲=被弾(同期)0.1s
  { t: 2100, s: 5, v: 3 },  // よろける 0.1s
  { t: 2200, s: 2, v: 4 },  // 崩れ落ちる 0.2s
  { t: 2400, s: 6, v: 5 },  // 硝煙・倒れ伏す(保持)
];
const SHOOT_FADE_START = 3700; // 最終コマを約1.3秒見せてから暗転(保持長は従来踏襲の叩き台)
const SHOOT_FADE_MS = 1200;
const SHOOT_TOTAL = 5100;
