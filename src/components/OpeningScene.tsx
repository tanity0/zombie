...
// 撃たれ側(社長指定v0.25.2011→2012で+0.5→2014で-0.2→2016でさらに-0.2ずつ): 被弾=撃つと同期(2.0s)→次0.3→次0.4→最後(倒れ伏す)は保持。
const SHOOTER_TRACK = [{ t: 0, f: 1 }, { t: 1000, f: 3 }, { t: 2000, f: 4 }, { t: 2100, f: 5 }, { t: 2200, f: 2 }, { t: 2400, f: 6 }];
const VICTIM_TRACK = [{ t: 0, f: 1 }, { t: 2000, f: 2 }, { t: 2300, f: 3 }, { t: 2700, f: 4 }, { t: 3100, f: 5 }];
...
const SHOOT_FADE_START = 4400; // 最終コマを約1.3秒見せてから暗転(保持長は従来踏襲の叩き台)
const SHOOT_FADE_MS = 1200;
const SHOOT_TOTAL = 5800;
