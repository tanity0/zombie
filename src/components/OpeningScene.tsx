...
const SHOTS: Shot[] = [
  ...
  // 【立ち位置合わせ(社長指示v0.25.2019)】ヒーローをx+1.7し、ズーム原点をヒーロー自身(50.7, 86)に
  // 置く=ズーム中ドリフト0・カット時の画面足元(218, 569)が斜めと完全一致。シルエットも+1.7で隊形維持・接地不変。
  { bg: A('arena-side.jpg'), ox: 50.7, oy: 86, zf: 1.7, zt: 2.1, flipScene: true, chars: [
    { src: TWIN, x: 44.7, y: 81, h: 25 }, { src: HERO, x: 50.7, y: 86, h: 28 }, { src: BOB, x: 59.7, y: 95, h: 35 },
  ] },
];
