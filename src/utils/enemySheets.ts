...
export const ENEMY_WALK_SHEETS: Readonly<Record<string, number>> = {
  ...
  // ★歩調は **2.61回転/秒(コマ33.9枚/秒)= 今までで一番速い**(比較: ハンター5.1 / ゾンビ8.5 /
  //   蜘蛛18.4 / 咆哮型27)。この型は雑魚で最速(108px/s)なので式どおりだが、**歩幅の倍率は既定のまま**
  //   にしてある(絵から測った1周期の歩幅は身長比 1.1〜2.4倍と幅があり、鞭が接地に混じって確定できない)。
  //   **走りに見えるなら倍率1行で落とせる。**
  'lich-common': 13,
};
