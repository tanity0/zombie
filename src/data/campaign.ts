...
export const SKILLS: Record<SkillKey, { name: string; desc: string; rarity: SkillRarity }> = {
  ...
  'fire-shooter': { name: 'ファイアシューター', desc: '撃った弾が時々爆発弾になる。連続では起きない', rarity: 'rare' },
  'bomb-counter': { name: 'ボムカウンター', desc: 'カウンターの反射弾が爆発する＋成立時に自分中心でも大爆発', rarity: 'rare' },
  'combo-master': { name: 'コンボマスター', desc: 'コンボが途切れるまでの猶予が延び、コンボ中は全攻撃が重くなる', rarity: 'rare' },
  'knife-master': { name: 'ナイフマスター', desc: '近接で当て続けるほど近接の一撃が重くなり、近接のクリティカルも出やすい。代わりにコンボが途切れやすく、弾薬は落ちなくなる', rarity: 'rare' },
  ...
  'reflex':       { name: '反射神経',       desc: '被弾すると反撃の爆発。再使用まで間がある', rarity: 'normal' },
  ...
  'dog-run':      { name: 'ドッグラン',     desc: '犬の再使用がとても早い・射程制限解除(犬装備時)', rarity: 'normal' },
  ...
  'magnet':       { name: 'マグネット',     desc: '近くの経験値が足元へ滑ってくる(Lvでコイン・弾も。覚醒でアイテムも。範囲も広がる)', rarity: 'normal' },
...
const SKILL_LEVEL_INFO: Partial<Record<SkillKey, { base: string; lv?: [string, string, string] }>> = {
  ...
  'knight':       { base: '被ダメージ減少＋盾/召喚の最大HP増加', lv: ['被ダメージ-20%／召喚HP+50%', '被ダメージ-30%／召喚HP+75%', '被ダメージ-40%／召喚HP+100%・覚醒=一定確率で被ダメージ無効化'] },
  ...
  'fire-shooter': { base: '発射が一定確率で爆発弾になる。連続では起きない', lv: ['20%', '25%', '30%・覚醒=大爆発(範囲×1.8)'] },
  ...
  'combo-master': { base: 'コンボが途切れるまでの猶予が延び、コンボ中は全攻撃が重くなる', lv: ['+2%/combo(上限+50%)・猶予+1.0s', '+3%/combo(上限+60%)・猶予+1.5s', '+4%/combo(上限+70%)・猶予+2.0s・覚醒=途切れても20秒間攻撃力を維持'] },
  'knife-master': { base: '近接で当て続けるほど近接が重くなる＋近接のクリティカルが出やすい。ただしコンボが途切れやすく、弾薬は落ちない', lv: ['+2%/hit(上限+40%)・近接クリ+10%', '+2%/hit(上限+50%)・+15%', '+4%/hit(上限+60%)・+20%・覚醒=近接の間合いが常にハンティング相当'] },
  'benkei':       { base: '武器を切り替えるとクリティカル率が一時上昇。切替先の弾倉が0でも1発装填', lv: ['+5%/10秒', '+10%/12秒', '+15%/15秒・覚醒=2発装填'] },
  'reflex':       { base: '被弾すると反撃の爆発。再使用まで間がある', lv: ['ダメージ60／半径92／再使用1.0s', '80／104／0.8s', '100／116／0.6s'] },
  ...
  'time-keeper':  { base: 'サブウェポンの再使用が早い', lv: ['-10%', '-20%', '-30%・覚醒=近接(カウンター)の再使用も-10%'] },
  'ghost-shooter':{ base: '一定確率で弾を消費しない', lv: ['10%', '20%', '30%・覚醒=消費しない代わりにリザーブから即補填(弾倉が減らない)'] },
  'dog-run':      { base: '犬の再使用が早い（犬装備時）', lv: ['再使用-50%', '再使用がとても早い', '再使用がとても早い＋射程制限解除'] },
  ...
  'attack-shooter':{ base: '銃ダメージが上昇し、弾も大きくなる', lv: ['+10%・弾×1.3', '+20%・弾×1.5', '+30%・弾×1.7・覚醒=近接と同じノックバック(免疫時間も同じ)'] },
  'runner':       { base: '移動速度が上昇。リロード中はさらに+10%', lv: ['+10%', '+15%', '+20%・覚醒=加速中の被ダメージ20%軽減'] },
  ...
  'magnet':       { base: '近くの落ち物を引き寄せる', lv: ['経験値を引き寄せる', 'コインと弾も引き寄せる・範囲が広がる', '覚醒=回復や爆弾などのアイテムも引き寄せる・範囲がさらに広がる'] },
  ...
  'incendiary-round':{ base: '被弾させた敵を燃焼させる(秒間ダメージ)', lv: ['3秒・毎秒2', '3秒・毎秒2＋着弾地点に小さな炎床', '4秒・毎秒4＋炎床(大)・覚醒=延焼が敵同士の接触で移る'] },
  ...
  'blood-treads':    { base: '移動軌跡に棘を残し、触れた敵に継続ダメージを与える', lv: ['2秒・毎秒2', '3秒・毎秒3', '4秒・毎秒4・覚醒=触れた敵を鈍足化'] },
};
