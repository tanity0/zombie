...
export const SKILLS: Record<SkillKey, { name: string; desc: string; rarity: SkillRarity }> = {
  ...
  'gravity-shot':    { name: 'グラビティショット',   desc: '射撃ヒット時、一定確率で周囲の敵を中心へ引き寄せる爆縮を発生させる', rarity: 'rare' },
...
const SKILL_LEVEL_INFO: Partial<Record<SkillKey, { base: string; lv?: [string, string, string] }>> = {
  ...
  'gravity-shot':    { base: '射撃ヒット時、一定確率で周囲の敵を中心へ引き寄せる爆縮を発生させる', lv: ['発動20%・半径100', '発動30%・半径120', '発動40%・半径140・覚醒=2倍の長さで引き寄せ続ける'] },
