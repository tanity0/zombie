...
export const SKILLS: Record<SkillKey, { name: string; desc: string; rarity: SkillRarity }> = {
  ...
  'execution-shock': { name: '処刑の爆発',           desc: '近接フィニッシュ時、その場で爆発を起こす(近接攻撃の表示ダメージ基準・ノックバック付き)', rarity: 'rare' },
...
const SKILL_LEVEL_INFO: Partial<Record<SkillKey, { base: string; lv?: [string, string, string] }>> = {
  ...
  'execution-shock': { base: '近接フィニッシュ時、その場で爆発を起こす(近接攻撃の表示ダメージ基準・ノックバック付き)', lv: ['半径80・近接30%', '半径100・40%', '半径120・50%'] },
