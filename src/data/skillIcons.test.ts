...
describe('skillIconStyle(切り出し)', () => {
  ...
  // ★実物のシートは**マスが正方形ではない**。この段の入力 5472×136(=1マス144×136)は
  // v0.25.3500 当時の実寸で、**v0.25.4588 の解凍で実物は 1368×34(1マス36×34)になった**が、
  // 比率が同じなので検査している性質(非正方マスを潰さずcontainで収める)は変わらない。
