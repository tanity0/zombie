...
export const NPC_SCENE_VARIANTS: { idx: number; cat: string; text: string }[] = [
  ...
  { idx: 2, cat: 'baseCaptured', text: 'ここは救護所にできます。負傷者を、こちらへ。' },  // dlg_000052
  { idx: 3, cat: 'baseCaptured', text: '拠点、制した。されど気を緩めるな。' },                      // dlg_000053
  { idx: 4, cat: 'baseCaptured', text: '拠点確保です。金城鉄壁、ここは守り抜きましょう。' },          // dlg_000054
  { idx: 5, cat: 'baseCaptured', text: '拠点確保。ふふ、完璧な布陣だ。君も実によく動いた。' },      // dlg_000055
  { idx: 6, cat: 'baseCaptured', text: '取れた！……あ、ここ水あるかな。' },    // dlg_000056
  { idx: 7, cat: 'baseCaptured', text: '……取ったか。浮かれるんじゃねえ、ここからだ。' },   // dlg_000057
  // sortie_start (出撃時)
  ...
  { idx: 2, cat: 'sortie', text: '出撃します。無茶をした方は、私が叱りますから。' },                 // dlg_000152
  { idx: 2, cat: 'sortie', text: '負傷者を増やすためではなく、救うために進みます。' },             // dlg_000153
  // surrounded (敵に囲まれた時)
  { idx: 0, cat: 'surrounded', text: '囲まれたか。焦るな、俺が前をこじ開ける！' },                  // dlg_000018
  { idx: 1, cat: 'surrounded', text: 'おいおい、歓迎されすぎだろ！出口作るぞ！' },                  // dlg_000019
  { idx: 2, cat: 'surrounded', text: 'ずいぶん無作法な囲み方ですこと。突破口を作ります。' },        // dlg_000020
  ...
  { idx: 2, cat: 'pushback', text: '敵圧が強すぎます。態勢を立て直しましょう。' },                    // dlg_000036
  ...
  { idx: 7, cat: 'pushback', text: '押されてる。だが、潰されるほど鈍くねえ。' },             // dlg_000041
  // base_near (拠点が見えてきた時)
  { idx: 0, cat: 'baseNear', text: '見えたぞ！ここまで押したのはお前の力だ！' },                    // dlg_000042
  { idx: 1, cat: 'baseNear', text: 'おっ、見えた見えた！あと少しで俺たちの場所だ！' },              // dlg_000043
  { idx: 2, cat: 'baseNear', text: 'あれが拠点かしら。人を守れる場所に戻しましょう。' },          // dlg_000044
  ...
  { idx: 7, cat: 'baseNear', text: '見えたな。油断すんな、最後が一番荒れる。' },             // dlg_000049
  ...
  { idx: 2, cat: 'companion', text: '無理なさらないで。ですが、その歩調、頼もしいこと。' },       // dlg_000080
  { idx: 2, cat: 'companion', text: 'そばにいれば、応急処置くらいはできます。安心なさい。' },       // dlg_000081
  { idx: 2, cat: 'companion', text: 'あなたとなら、この道も少しは安全に見えます。' },         // dlg_000082
  ...
  { idx: 7, cat: 'companion', text: '調子いいじゃねえか。なら、俺も付き合ってやる。' },      // dlg_000097
  // left_alone (遠くで放置時)
  { idx: 7, cat: 'neglectFar', text: 'こっちは詰まってる。助けに来いとは言ってねえぞ。' },    // dlg_000009
  ...
  { idx: 2, cat: 'neglectFar', text: 'こちらは持ちこたえています。ただ、長くは保ちません。' },     // dlg_000128
  { idx: 2, cat: 'neglectFar', text: '余裕があれば、こちらへ。負傷者を出す前に、整えておきたくて。' },   // dlg_000129
  ...
  { idx: 7, cat: 'neglectFar', text: 'こっちが先に潰れるぞ。……聞こえてんだろ。' },              // dlg_000143
  ...
  { idx: 2, cat: 'rescueReturned', text: 'ご無事で何より。あなたも、よくお守りになって。' },   // dlg_000060
  { idx: 2, cat: 'rescueReturned', text: 'たった一人でも、戻れた命には意味があります。' },          // dlg_000004
  ...
  { idx: 7, cat: 'rescueReturned', text: '……生きてたか。こいつの面倒は、俺が見る。' },      // dlg_000065
  ...
  { idx: 2, cat: 'npcKill', text: '排除いたしました。これで少しは、安全でしょう。' },                 // dlg_000104
  { idx: 2, cat: 'npcKill', text: '近づきすぎですのよ。無作法な方には下がっていただきます。' },       // dlg_000105
