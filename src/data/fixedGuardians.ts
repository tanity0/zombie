...
export const FIXED_GUARDIANS: readonly FixedGuardian[] = [
  ...
  fixedGuardian({
    ...
    equipment: gear('body-protection-4', 'special-arms', 'special-accessory'),
    skills: skillBuild('counter-master', 'knight', 2, 2),
  }),
  fixedGuardian({
    ...
    equipment: gear('body-mobility-5', 'arms-firepower-5', 'accessory-crit-5'),
    skills: skillBuild('counter-master', 'knife-master'),
  }),
  fixedGuardian({
    ...
    equipment: gear('body-mobility-5', 'arms-handling-5', 'accessory-crit-4'),
    skills: skillBuild('ghost-shooter', 'ricochet'),
  }),
  fixedGuardian({
    ...
    equipment: gear('special-body', 'arms-handling-5', 'accessory-crit-5'),
    skills: skillBuild('attack-shooter', 'ricochet'),
  }),
  fixedGuardian({
    ...
    equipment: gear('body-mobility-4', 'special-arms', 'accessory-crit-3'),
    skills: skillBuild('ghost-shooter', 'attack-shooter', 2, 2),
  }),
  fixedGuardian({
    ...
    equipment: gear('body-protection-5', 'arms-firepower-3', 'special-accessory'),
  ...
  fixedGuardian({
    ...
    equipment: gear('body-protection-5', 'arms-handling-5', 'accessory-ammo-5'),
    skills: skillBuild('knight', 'ghost-shooter'),
  }),
  fixedGuardian({
    ...
    approachPerMin: 5, subUsesPerMin: 8,
    equipment: gear('body-protection-5', 'special-arms', 'accessory-ammo-5'),
    skills: skillBuild('knight', 'time-keeper'),
  }),
  fixedGuardian({
    ...
    equipment: gear('body-protection-2', 'arms-firepower-5', 'accessory-crit-5'),
  ...
  fixedGuardian({
    ...
    equipment: gear('body-protection-1', 'arms-firepower-5', 'accessory-crit-5'),
    skills: skillBuild('sniper', 'sharpshooter'),
  }),
  fixedGuardian({
    ...
    equipment: gear('special-body', 'arms-firepower-5', 'special-accessory'),
    skills: skillBuild('sniper', 'attack-shooter', 2, 3),
  }),
  fixedGuardian({
    ...
    equipment: gear('body-mobility-5', 'arms-handling-5', 'accessory-crit-5'),
    skills: skillBuild('attack-shooter', 'last-magazine'),
  }),
  fixedGuardian({
    ...
    equipment: gear('body-mobility-4', 'arms-firepower-5', 'accessory-crit-4'),
    skills: skillBuild('attack-shooter', 'ghost-shooter', 2, 3),
  }),
  fixedGuardian({
  ...
  fixedGuardian({
    ...
    equipment: gear('body-protection-4', 'special-arms', 'accessory-ammo-5'),
  ...
  fixedGuardian({
    ...
    equipment: gear('special-body', 'arms-handling-5', 'accessory-ammo-5'),
    skills: skillBuild('time-keeper', 'knight'),
  }),
  fixedGuardian({
  ...
  fixedGuardian({
    ...
    equipment: gear('body-mobility-5', 'arms-firepower-5', 'accessory-crit-5'),
    skills: skillBuild('crit-up', 'attack-shooter'), phillHeadshotRate: 1,
  }),
  fixedGuardian({
    ...
    equipment: gear('body-protection-4', 'arms-firepower-5', 'accessory-crit-5'),
    skills: skillBuild('knife-master', 'counter-master'),
  }),
];
