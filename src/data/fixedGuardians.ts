  ...
  return {
    ...
    profile: {
      ...
      snapshot: {
        ...
        subWeapons: s.subWeapons,
        subWeaponLevels: subLevels(s.subWeapons),
...
export const FIXED_GUARDIANS: readonly FixedGuardian[] = [
  fixedGuardian({
    ...
    gunKey: 'shotgun-t3', meleeKey: 'anti-mutant-knife-t5', subWeapons: ['heavy-grenade'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t2', meleeKey: 'tactical-knife-t4', subWeapons: ['shield'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t3', meleeKey: 'machete-t3', subWeapons: ['fire-knife'],
  ...
  fixedGuardian({
    ...
    gunKey: 'rifle-t1', meleeKey: 'machete-t3', subWeapons: ['decoy'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t3', meleeKey: 'knife-t1', subWeapons: ['molotov'],
  ...
  fixedGuardian({
    ...
    gunKey: 'shotgun-t2', meleeKey: 'hatchet-t2', subWeapons: ['drone-boomerang'],
  ...
  fixedGuardian({
    ...
    gunKey: 'shotgun-t1', meleeKey: 'anti-mutant-knife-t5', subWeapons: ['first-aid-kit'],
  ...
  fixedGuardian({
    ...
    gunKey: 'rifle-t1', meleeKey: 'tactical-knife-t4', subWeapons: ['turret'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t1', meleeKey: 'machete-t3', subWeapons: ['marksman-trap'],
  ...
  fixedGuardian({
    ...
    gunKey: 'rifle-t2', meleeKey: 'knife-t1', subWeapons: ['support-sniper'],
  ...
  fixedGuardian({
    ...
    gunKey: 'rifle-t2', meleeKey: 'knife-t1', subWeapons: ['marksman-trap'],
  ...
  fixedGuardian({
    ...
    gunKey: 'rifle-t3', meleeKey: 'hatchet-t2', subWeapons: ['heavy-grenade'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t3', meleeKey: 'machete-t3', subWeapons: ['striker-quick-mag'],
  ...
  fixedGuardian({
    ...
    gunKey: 'shotgun-t3', meleeKey: 'hatchet-t2', subWeapons: ['flare-gun'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t2', meleeKey: 'knife-t1', subWeapons: ['homing'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t1', meleeKey: 'tactical-knife-t4', subWeapons: ['turret', 'decoy'],
  ...
  fixedGuardian({
    ...
    gunKey: 'shotgun-t2', meleeKey: 'machete-t3', subWeapons: ['shield', 'marksman-trap'],
  ...
  fixedGuardian({
    ...
    gunKey: 'rifle-t1', meleeKey: 'anti-mutant-knife-t5', subWeapons: ['junk-weapon'],
  ...
  fixedGuardian({
    ...
    gunKey: 'phill-revolver', meleeKey: 'machete-t3', subWeapons: ['fire-knife'],
  ...
  fixedGuardian({
    ...
    gunKey: 'handgun-t1', meleeKey: 'anti-mutant-knife-t5', subWeapons: ['katana'],
