# HANDOFF_CODEX.md — Codexへの引き継ぎブリーフ(v0.26.15時点・方向転換フォーク)
...
| R7 | エリア台本(PACING_V2.md§2): エリア1〜4で15秒ロール×エリア別確率[0,0.20,0.25,0.30,0.35]で問題児セット注入。キャップ=パンプキン2/犬2/弾3、別枠=叫び1/ゴースト2(3分超orエリア3以降)。ディレクター連携(RELAX中・intensity≥0.75・pity中は発火しない) | v0.26.13 |
